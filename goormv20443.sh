...
wget --no-check-certificate https://github.com/eshion/goorm-v2ray/blob/master/config.json
rm -f /v2ray/1.key
wget --no-check-certificate https://github.com/eshion/goorm-v2ray/blob/master/1.key
rm -f /v2ray/1.crt
wget --no-check-certificate https://github.com/eshion/goorm-v2ray/blob/master/1.crt
